...
void demo_cppstring(class_ticket in_t1, class_ticket in_t2)
{
	...
	cout << "Customer name (using assignment operator): " << t1.customer_name << endl;
	...
	//strcpy_s(t1.customer_name, name); // Throws a compile time error
...
void demo_cstring(struct_ticket in_t1, struct_ticket in_t2)
{
    ...
    printf("Enter a name: \n");
	//scanf_s("%s", t1.customer_name2); // Throws a runtime exception!
    ...
    printf("Enter a name: \n");
	//scanf_s("%s", &t1.customer_name3); // Throws a runtime exception!
	...
	// Assign value using standard 'string' library functions
	//strcpy_s(t1.customer_name3, newname);  // Throws a compile time error!
	printf("Customer Name3: %s\n", t1.customer_name3);
